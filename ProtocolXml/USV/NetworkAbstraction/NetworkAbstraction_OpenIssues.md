...
- `공용 구조체.csv`의 `GeoSatModulatorStatus` / `GeoSatDemodulatorStatus` 정의를 재확인하여 `outputLevel=UInt32`, `dataBW/dataRate=Float64`, `signalPower=Float32`, `cn/ber/bitRate/trafficRate=Float64`로 Binding 자료형을 확정하였다.
...
2. **PBIT/IBIT Result correlation 및 대상 식별**
...
7. **공용 Network/L-Band/GeoSat/Aux Result source routing**
